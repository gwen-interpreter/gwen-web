...
libraryDependencies += "org.seleniumhq.selenium" % "selenium-chrome-driver" % "3.5.1"

libraryDependencies += "org.seleniumhq.selenium" % "selenium-firefox-driver" % "3.5.1"

libraryDependencies += "org.seleniumhq.selenium" % "selenium-ie-driver" % "3.5.1"

libraryDependencies += "org.seleniumhq.selenium" % "selenium-safari-driver" % "3.5.1"

libraryDependencies += "org.seleniumhq.selenium" % "selenium-support" % "3.5.1" excludeAll(
