...
libraryDependencies += "org.seleniumhq.selenium" % "selenium-chrome-driver" % "3.7.1"

libraryDependencies += "org.seleniumhq.selenium" % "selenium-firefox-driver" % "3.7.1"

libraryDependencies += "org.seleniumhq.selenium" % "selenium-ie-driver" % "3.7.1"

libraryDependencies += "org.seleniumhq.selenium" % "selenium-safari-driver" % "3.7.1"

libraryDependencies += "org.seleniumhq.selenium" % "selenium-support" % "3.7.1" excludeAll(
