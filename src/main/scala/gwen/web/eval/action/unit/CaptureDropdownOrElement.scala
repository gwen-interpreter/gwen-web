...
import gwen.core.eval.action.unit.Capture
import gwen.core.node.GwenNode
import gwen.core.node.gherkin.Step

class CaptureDropdownOrElement(target: Option[String], element: String, selection: DropdownSelection) extends UnitStepAction[WebContext] {
