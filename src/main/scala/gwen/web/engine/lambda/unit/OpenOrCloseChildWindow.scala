...
class OpenOrCloseChildWindow[T <: EvalContext](open: Boolean, occurence: Option[Int], engine: EvalEngine[WebContext], ctx: WebContext) extends UnitStep[WebContext](engine, ctx) {
