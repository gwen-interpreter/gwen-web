...
class CompareToBoundValue[T <: EvalContext](name: String, source: String, actual: () => String, operator: ComparisonOperator.Value, negate: Boolean, engine: EvalEngine[WebContext], ctx: WebContext) extends UnitStep[WebContext](engine, ctx) {
