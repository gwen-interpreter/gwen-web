...
class WaitForText[T <: EvalContext](element: String, waitSecs: Option[Long], engine: EvalEngine[WebContext], ctx: WebContext) extends UnitStep[WebContext](engine, ctx) {
