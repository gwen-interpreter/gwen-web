...
class DriverManager() extends LazyLogging {
  ...
  private [engine] val drivers: mutable.Map[String, WebDriver] = mutable.Map()
  ...
  private [engine] def loadWebDriver: WebDriver = withGlobalSettings {
  ...
  private [engine] def chrome(): WebDriver = {
  ...
  private [engine] def firefox(): WebDriver = {
  ...
  private [engine] def ie(): WebDriver = {
  ...
  private [engine] def edge(): WebDriver = {
  ...
  private [engine] def safari(): WebDriver = {
    new SafariDriver(safariOptions())
  }

  private [engine] def remote(hubUrl: String, capabilities: DesiredCapabilities): WebDriver =
